...
// Handle status toggle if form is submitted
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['toggle_status'])) {
    ...
    $_SESSION['lab_status'][$day][$time][$lab] = 
        ($_SESSION['lab_status'][$day][$time][$lab] ?? 'available') == 'available' ? 'occupied' : 'available';
...
$defaultStatuses = [
    'mw' => [
        ...
        // ... add all other time slots for Monday/Wednesday
    ],
    'tt' => [
        '7:30AM–9:00AM' => ['517'=>'available', '524'=>'occupied', '526'=>'available', '528'=>'occupied', '530'=>'available', '542'=>'available'],
        // ... add all other time slots for Tuesday/Thursday
    ],
    // ... add Friday and Saturday schedules
];
...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="lab_schedule.php" class="active"><i class="fas fa-calendar-alt"></i> <span>Lab Schedule</span></a></li>
